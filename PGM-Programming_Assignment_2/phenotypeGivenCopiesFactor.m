...
for i = 1:numAlleles
    for j = 1:numAlleles
        assignment1 = [1, i, j];
        assignment2 = [2, i, j];
        phenotypeFactor.val(AssignmentToIndex(assignment1, phenotypeFactor.card)) = ...
            alphaList(allelesToGenotypes(i, j));
        phenotypeFactor.val(AssignmentToIndex(assignment2, phenotypeFactor.card)) = ...
            1 - alphaList(allelesToGenotypes(i, j));
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%